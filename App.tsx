...
// //   const { requestPhotoPermissions } = useImagePicker();
...
//             allowsEditing: false, // 갤러리만 열고 편집은 비활성화
//           });

//           console.log('갤러리 선택 완료:', result);
...
//                   try {
//                     // 로그 추가
//                     console.log('이미지 처리 시작:', asset.uri);
...
//                         ? `데이터 있음 (길이: ${
//                             base64.length
//                           }, 앞부분: ${base64.substring(0, 50)}...)`
//                         : '데이터 없음'
//                     );
//                     // 파일 정보와 함께 dataUrl 형식으로 전송
//                     return {
//                       uri: asset.uri,
//                       width: asset.width,
//                       height: asset.height,
...
//                 console.log('웹으로 이미지 전송:', validImages.length);
